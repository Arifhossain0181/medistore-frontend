    ...
    return (
        <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-100 px-4 py-6 dark:bg-slate-950 md:py-8">
            ...
            >
                ...
                <h1 className="text-center text-3xl font-bold tracking-tight text-emerald-700 dark:text-emerald-300">Create Account</h1>
                <p className="mt-1 text-center text-sm text-slate-600 dark:text-slate-300">Join Medistore and start your healthcare journey.</p>
